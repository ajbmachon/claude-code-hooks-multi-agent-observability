...
def send_event_to_server(event_data, server_url='http://localhost:4005/events'):
...
def main():
    ...
    parser.add_argument('--server-url', default='http://localhost:4005/events', help='Server URL')
